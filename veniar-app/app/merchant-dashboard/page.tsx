...
export const metadata: Metadata = {
  ...
  description:
    'See how the Veniar merchant dashboard gives independent businesses real reporting on loyalty activity, offers, and network performance.',
};

const DASHBOARD_MODULES = [
  {
    title: 'Points activity',
    desc: 'Points issued, redeemed, and net balance by day, week, or month. Filter by staff member or service type.',
    tag: 'Reporting',
  },
  {
    title: 'Customer list',
    desc: 'Every customer who has transacted at your location. See visit count, total points earned, and last visit date.',
    tag: 'Customers',
  },
  {
    title: 'Offer management',
    desc: 'Create, activate, pause, and edit bonus point events. Control start and end dates and points multipliers.',
    tag: 'Offers',
  },
  {
    title: 'Staff access',
    desc: 'Add staff email addresses to give them access to the employee portal. No owner credentials shared.',
    tag: 'Team',
  },
  {
    title: 'Network referrals',
    desc: 'Customers who visited your location after first earning points at another Veniar partner — network-driven traffic.',
    tag: 'Network',
  },
  {
    title: 'Monthly settlement',
    desc: 'Points issued and redeemed across the network, broken down by period. Settlement reports are generated monthly.',
    tag: 'Settlement',
  },
];
    ...
    <>
      ...
      <section className="bg-vn-ivory border-b border-black/[0.08]">
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28">
          ...
          <h1 className="text-4xl lg:text-5xl font-black text-vn-ink leading-tight tracking-tight mb-4 max-w-3xl">
            See how loyalty turns into measurable local activity.
          </h1>
          <div className="w-10 h-[3px] bg-vn-obi-teal mb-7" />
          <p className="text-vn-muted text-lg leading-relaxed max-w-xl mb-10">
            The Veniar merchant dashboard gives independent business owners a clear view of
            points activity, offers, customer behavior, and network performance — all in one place.
          </p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/business" className="px-7 py-3.5 text-sm font-semibold text-vn-ink border border-black/[0.15] rounded hover:bg-black/[0.04] transition-colors">
      ...
      <section className="bg-vn-deep-flight border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-6 py-16 lg:py-20">
          <p className="text-xs font-bold tracking-[0.22em] uppercase text-vn-obi-teal mb-6">
            DASHBOARD PREVIEW
          </p>
              ...
              <div className="bg-white/[0.04] border border-white/[0.08] rounded-lg overflow-hidden">
                <div className="grid grid-cols-4 gap-4 px-4 py-2.5 bg-white/[0.04] border-b border-white/[0.06]">
                  {['Customer', 'Points issued', 'Redemptions', 'Last visit'].map((h) => (
                    <p key={h} className="text-white/35 text-[10px] font-bold uppercase tracking-widest">
                      {h}
                    </p>
                  ))}
                </div>
          ...
          <p className="text-white/30 text-xs mt-4">
            Dashboard preview — placeholder UI only. Actual data shown after onboarding.
          </p>
        </div>
      </section>
      ...
      <section className="bg-rn-cloud border-b border-black/[0.06]">
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-24">
          ...
          <h2 className="text-2xl lg:text-3xl font-black text-vn-ink mb-4 tracking-tight">
            Every tool for running your loyalty program.
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {DASHBOARD_MODULES.map((m) => (
              <div key={m.title} className="border border-black/[0.1] rounded-lg bg-white p-6">
                <span className="inline-block text-[10px] font-bold tracking-widest uppercase text-vn-obi-teal border border-vn-obi-teal/30 rounded px-2 py-0.5 mb-4">
                  {m.tag}
                </span>
      ...
      <section className="bg-vn-ivory border-b border-black/[0.06]">
        <div className="max-w-4xl mx-auto px-6 py-16 lg:py-20">
          <div className="border border-black/[0.1] rounded-lg bg-white p-8">
            ...
            <h3 className="font-bold text-vn-ink mb-3 text-lg">Dashboard access is included with every Veniar plan.</h3>
            <p className="text-vn-muted text-sm leading-relaxed mb-6">
              All Veniar merchants get access to the full dashboard from day one. There&apos;s no
              separate reporting tier or upgrade required. Staff access and the employee portal
              are also included.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link href="/pricing" className="px-5 py-2.5 text-sm font-bold text-white bg-vn-flight-blue rounded hover:bg-[#094d92] transition-colors">
                View pricing
              </Link>
              <Link href="/join" className="px-5 py-2.5 text-sm font-semibold text-vn-ink border border-black/[0.15] rounded hover:bg-black/[0.04] transition-colors">
                Apply now
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-black text-white mb-2 tracking-tight">
              Ready to see your loyalty data?
            </h2>
