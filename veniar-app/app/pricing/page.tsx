...
export const metadata: Metadata = {
  ...
  description:
    'Simple, transparent pricing for independent restaurants and local businesses joining the Veniar Network.',
};
...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Shared customer base across locations',
...
const FAQ = [
  {
    ...
    a: 'No long-term contract is required during the founding network period. Veniar operates on a monthly basis.',
  },
  {
    q: 'Are there setup fees?',
    a: 'There are no setup fees for founding network members. Onboarding is handled by the Veniar team.',
  },
  {
    q: "What's included in the founding network offer?",
    a: 'Founding network merchants get priority onboarding, locked-in founding pricing, and direct access to the Veniar team during setup.',
  },
  {
    q: 'Can I upgrade my plan later?',
    a: 'Yes. You can move between plans at any time. Contact the Veniar support team to adjust your plan.',
  },
  {
    q: 'How does billing work for multi-location?',
    a: 'Multi-location operators are billed at the account level, not per location. Pricing is based on the number of active locations.',
  },
];
      ...
      <section className="bg-vn-ivory border-b border-black/[0.08]">
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28">
          ...
          <h1 className="text-4xl lg:text-5xl font-black text-vn-ink leading-tight tracking-tight mb-4 max-w-2xl">
            Simple pricing for independent businesses.
          </h1>
          <div className="w-10 h-[3px] bg-vn-obi-teal mb-7" />
          <p className="text-vn-muted text-lg leading-relaxed max-w-xl">
            Veniar is in its founding network phase. Pricing is by application during this
            period — early partners get locked-in founding rates.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-24">
          <div className="grid md:grid-cols-3 gap-4">
            {PLANS.map((plan) => (
              <div
                key={plan.name}
                className={`border-t-4 ${plan.accent} border border-black/[0.1] rounded-lg bg-white p-7 flex flex-col ${plan.featured ? 'ring-1 ring-vn-flight-blue/30' : ''}`}
              >
                {plan.featured && (
                  <span className="inline-block text-[10px] font-bold tracking-widest uppercase text-vn-flight-blue bg-vn-flight-blue/[0.08] border border-vn-flight-blue/20 rounded px-2 py-0.5 mb-4 self-start">
                    Most popular
                  </span>
                )}
                ...
                <Link
                  href={plan.href}
                  className="block text-center px-5 py-3 text-sm font-bold text-white bg-vn-flight-blue rounded hover:bg-[#094d92] transition-colors"
                >
                  {plan.cta}
                </Link>
              </div>
      ...
      <section className="bg-vn-ivory border-b border-black/[0.06]">
        <div className="max-w-4xl mx-auto px-6 py-16 lg:py-20">
          <div className="border border-black/[0.1] rounded-lg bg-white p-8">
            <p className="text-xs font-bold tracking-[0.22em] uppercase text-vn-sunset-gold mb-4">
              FOUNDING NETWORK
            </p>
            <h2 className="text-xl font-black text-vn-ink mb-3 tracking-tight">
              Early partners get locked-in founding pricing.
            </h2>
            <div className="w-8 h-[3px] bg-vn-obi-teal mb-5" />
            <p className="text-vn-muted text-sm leading-relaxed mb-4">
              Veniar is building its founding network now. Merchants who join during this phase
              get priority onboarding, a direct line to the Veniar team, and their current pricing
              locked in as the network grows.
            </p>
            <p className="text-vn-muted text-sm leading-relaxed mb-6">
              There&apos;s no long-term contract required during this period. If you have questions
              about pricing for your specific business, contact us directly.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link
                href="/join"
                className="px-5 py-2.5 text-sm font-bold text-vn-ink bg-vn-sunset-gold rounded hover:bg-[#d9a43f] transition-colors"
              >
                Apply now
              </Link>
              <a
                href={`mailto:${SUPPORT_EMAIL}`}
                className="px-5 py-2.5 text-sm font-semibold text-vn-ink border border-black/[0.15] rounded hover:bg-black/[0.04] transition-colors"
              >
                Contact us
              </a>
            </div>
