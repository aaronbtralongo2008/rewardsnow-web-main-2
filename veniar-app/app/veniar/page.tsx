...
export const metadata: Metadata = {
  ...
  description: 'Learn how Veniar works — the shared rewards network for independent restaurants and local businesses.',
};
    ...
    <>
      <section className="bg-vn-ivory border-b border-black/[0.08]">
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28">
          <p className="text-xs font-bold tracking-[0.22em] uppercase text-vn-obi-teal mb-5">ABOUT VENIAR</p>
          <h1 className="text-4xl lg:text-5xl font-black text-vn-ink leading-tight tracking-tight mb-4 max-w-3xl">Veniar is the shared rewards network for local favorites.</h1>
      ...
      <section className="bg-rn-cloud border-b border-black/[0.06]">
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-24 grid md:grid-cols-2 gap-16">
          <div>
            <p className="text-xs font-bold tracking-[0.22em] uppercase text-vn-sunset-gold mb-5">WHAT IT IS</p>
            <h2 className="text-2xl lg:text-3xl font-black text-vn-ink mb-4 tracking-tight leading-tight">A shared loyalty network for independent businesses.</h2>
            <div className="w-8 h-[3px] bg-vn-obi-teal mb-6" />
            <p className="text-vn-muted text-base leading-relaxed mb-4">Veniar is a product of RewardsNow that connects independent restaurants, cafes, bakeries, and local businesses through a shared rewards system.</p>
            <p className="text-vn-muted text-base leading-relaxed">When a customer earns Veniar Points at one business, they can use them at any other participating Veniar business. The more merchants who join, the more valuable the network becomes for everyone.</p>
          </div>
          <div>
            <p className="text-xs font-bold tracking-[0.22em] uppercase text-vn-sunset-gold mb-5">WHO IT IS FOR</p>
            <h2 className="text-2xl lg:text-3xl font-black text-vn-ink mb-4 tracking-tight leading-tight">Independent businesses and their customers.</h2>
            <div className="w-8 h-[3px] bg-vn-obi-teal mb-6" />
      ...
      <section className="bg-vn-deep-flight">
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-24">
          <p className="text-xs font-bold tracking-[0.22em] uppercase text-vn-sunset-gold mb-5">HOW POINTS WORK</p>
          <h2 className="text-2xl lg:text-3xl font-black text-white mb-4 tracking-tight leading-tight">Veniar Points — shared, local, network-native.</h2>
          ...
          <div className="mt-10 border border-white/[0.12] rounded-lg p-6">
            <p className="text-white/40 text-xs leading-relaxed">
              ...
              Veniar Points are promotional rewards. They are not cash, currency, stored value, or transferable money. Rewards are subject to Veniar Rewards Terms and participating merchant rules.{' '}
              <Link href="/rewards-terms" className="text-vn-obi-teal hover:underline underline-offset-4">Veniar Rewards Terms →</Link>
            </p>
          </div>
        </div>
      </section>
      <section className="bg-vn-ivory border-b border-black/[0.06]">
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-24">
          <p className="text-xs font-bold tracking-[0.22em] uppercase text-vn-sunset-gold mb-5">WHY SHARED LOYALTY</p>
          <h2 className="text-2xl lg:text-3xl font-black text-vn-ink mb-4 tracking-tight max-w-2xl leading-tight">A shared network creates value no single business can build alone.</h2>
          <div className="w-8 h-[3px] bg-vn-obi-teal mb-8" />
          <div className="grid md:grid-cols-2 gap-10 max-w-4xl">
            <div>
              <p className="text-vn-muted text-base leading-relaxed mb-4">Traditional loyalty programs only reward customers at the business that issued the points. That means every merchant builds a siloed program with no network effect and no new customer discovery.</p>
              <p className="text-vn-muted text-base leading-relaxed">Veniar changes that. Every new business that joins makes the network more useful for every customer — which makes it more valuable for every other merchant.</p>
            </div>
            <div className="space-y-4">
              {[
      ...
      <section className="bg-vn-flight-blue">
        <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-black text-white mb-2 tracking-tight">Ready to join the Veniar Network?</h2>
