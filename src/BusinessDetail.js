...
const s = {
  ...
  avatar: { borderRadius: '14px', background: 'linear-gradient(135deg, #1e40af, #2563eb)', color: '#fff', fontWeight: '700', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  categoryTag: { background: '#eff6ff', color: BLUE, fontSize: '11px', fontWeight: '700', padding: '3px 10px', borderRadius: '6px' },
  ...
  matchedTag: { background: '#dbeafe', color: '#1e40af', fontSize: '11px', fontWeight: '700', padding: '2px 8px', borderRadius: '20px' },
  aiCard: { background: 'linear-gradient(135deg, #0f172a 0%, #1e3a8a 100%)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: '14px', padding: '18px', marginBottom: '20px' },
  ...
  keyFactor: { background: 'rgba(165,180,252,0.2)', color: '#a5b4fc', fontSize: '11px', fontWeight: '600', padding: '3px 10px', borderRadius: '20px', border: '1px solid rgba(165,180,252,0.3)' },
