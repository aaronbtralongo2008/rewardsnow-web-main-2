...
const s = {
  root: { minHeight: '100vh', background: '#FFF8EA', fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif" },
  ...
  backBtn: { background: 'none', border: '1px solid rgba(255,255,255,0.2)', color: '#fff', fontSize: '13px', fontWeight: '500', cursor: 'pointer', padding: '6px 12px', borderRadius: '6px' },
  navBrand: { color: '#F2B84B', fontSize: '15px', fontWeight: '700' },
  navLogout: { background: 'none', border: '1px solid rgba(255,255,255,0.2)', color: '#fff', fontSize: '13px', fontWeight: '500', cursor: 'pointer', padding: '6px 14px', borderRadius: '6px' },
  body: { maxWidth: '900px', margin: '0 auto', boxSizing: 'border-box' },
  bizHeader: { display: 'flex', alignItems: 'flex-start', marginBottom: '24px' },
  avatar: { borderRadius: '14px', background: BLUE, color: '#fff', fontWeight: '700', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  bizInfo: { flex: 1, minWidth: '200px' },
  bizNameRow: { display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap', marginBottom: '6px' },
  bizName: { color: '#101820', fontWeight: '700', margin: 0, letterSpacing: '-0.02em' },
  featuredTag: { background: '#F2B84B', color: '#07243A', fontSize: '11px', fontWeight: '700', padding: '3px 8px', borderRadius: '6px' },
  bizAddr: { color: '#5F6B73', fontSize: '13px', margin: '0 0 10px' },
  bizMeta: { display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '8px' },
  categoryTag: { background: 'rgba(37,183,200,0.12)', color: '#25B7C8', fontSize: '11px', fontWeight: '700', padding: '3px 10px', borderRadius: '6px' },
  ...
  typeTag: { background: 'rgba(11,92,173,0.08)', color: BLUE, fontSize: '11px', fontWeight: '600', padding: '3px 10px', borderRadius: '6px', border: '1px solid rgba(11,92,173,0.15)' },
  typeTagCustom: { background: '#f5f3ff', color: '#7c3aed', border: '1px solid #e9d5ff' },
  directionsBtn: { background: 'none', border: '1px solid rgba(0,0,0,0.12)', color: '#5F6B73', fontSize: '12px', fontWeight: '500', cursor: 'pointer', padding: '3px 10px', borderRadius: '6px' },
  tagsRow: { display: 'flex', gap: '6px', flexWrap: 'wrap' },
  tagChip: { background: '#f1f5f9', color: '#475569', fontSize: '11px', fontWeight: '500', padding: '2px 8px', borderRadius: '20px', border: '1px solid rgba(0,0,0,0.06)' },
  compatCard: { background: '#fff', border: '1.5px solid rgba(11,92,173,0.15)', borderRadius: '14px', padding: '18px', marginBottom: '20px' },
  compatHeader: { display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' },
  compatScore: { fontSize: '13px', fontWeight: '800', padding: '4px 12px', borderRadius: '20px' },
  ...
  matchedTag: { background: 'rgba(11,92,173,0.1)', color: BLUE, fontSize: '11px', fontWeight: '700', padding: '2px 8px', borderRadius: '20px' },
  aiCard: { background: '#07243A', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '14px', padding: '18px', marginBottom: '20px' },
  aiCardHeader: { display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' },
  aiIcon: { color: '#25B7C8', fontSize: '14px' },
  aiTitle: { color: '#e0e7ff', fontSize: '13px', fontWeight: '700' },
  aiExplanation: { color: 'rgba(255,255,255,0.75)', fontSize: '13px', lineHeight: 1.6, margin: '0 0 12px' },
  keyFactors: { display: 'flex', gap: '6px', flexWrap: 'wrap', marginBottom: '10px' },
  keyFactor: { background: 'rgba(37,183,200,0.15)', color: '#25B7C8', fontSize: '11px', fontWeight: '600', padding: '3px 10px', borderRadius: '20px', border: '1px solid rgba(37,183,200,0.25)' },
  aiTip: { color: 'rgba(255,255,255,0.55)', fontSize: '12px', margin: 0, fontStyle: 'italic' },
  ...
  section: {},
  sectionTitle: { color: '#101820', fontSize: '15px', fontWeight: '700', margin: '0 0 16px', letterSpacing: '-0.01em' },
  grid: { display: 'grid', gap: '14px' },
  skeleton: { height: '160px', borderRadius: '12px', background: '#f0f0f0' },
  card: { background: '#fff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '12px', padding: '18px', display: 'flex', flexDirection: 'column', gap: '8px' },
  cardTop: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '8px' },
  svcName: { color: '#101820', fontSize: '14px', fontWeight: '600', margin: 0, flex: 1 },
  earnPill: { background: '#f0fdf4', color: '#16a34a', fontSize: '11px', fontWeight: '700', padding: '3px 8px', borderRadius: '6px', flexShrink: 0 },
  svcDesc: { color: '#5F6B73', fontSize: '13px', margin: 0, lineHeight: 1.5, flex: 1 },
  cardBottom: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '12px', borderTop: '1px solid rgba(0,0,0,0.06)', marginTop: 'auto' },
  ...
  empty: { background: '#fff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '12px', padding: '48px 24px', textAlign: 'center' },
