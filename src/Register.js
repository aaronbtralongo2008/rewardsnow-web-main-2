...
const s = {
  ...
  registerBtn: { padding: '14px', borderRadius: '10px', border: 'none', background: '#0B5CAD', color: '#ffffff', fontSize: '15px', fontWeight: '700', cursor: 'pointer', width: '100%', marginTop: '4px', transition: 'background-color 0.15s ease' },
