...
const styles = {
  ...
  mobileHeader: { background: 'linear-gradient(145deg, #08011a 0%, #1a0533 100%)', padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'center' },
  ...
  badge: { display: 'inline-block', color: '#22d3ee', fontSize: '12px', fontWeight: '700', letterSpacing: '4px', marginBottom: '20px' },
  ...
  rightPanel: { display: 'flex', flexDirection: 'column', justifyContent: 'center', background: '#faf8ff', boxSizing: 'border-box' },
  ...
  inputLabel: { color: '#7c3aed', fontSize: '10px', fontWeight: '700', marginBottom: '7px', display: 'block', letterSpacing: '2px', textTransform: 'uppercase' },
  input: { padding: '14px 16px', borderRadius: '10px', border: '2px solid #ede8fa', background: '#fff', color: '#0f172a', fontSize: '15px', marginBottom: '20px', outline: 'none', width: '100%', boxSizing: 'border-box' },
  loginBtn: { padding: '16px', borderRadius: '12px', border: 'none', background: 'linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%)', color: '#ffffff', fontSize: '16px', fontWeight: '700', cursor: 'pointer', width: '100%', boxShadow: '0 4px 24px rgba(124, 58, 237, 0.45)', letterSpacing: '0.02em' },
  forgotLink: { color: '#7c3aed', fontSize: '13px', fontWeight: '600', cursor: 'pointer' },
  registerBtn: { padding: '15px', borderRadius: '12px', border: '2px solid #ede8fa', background: '#fff', color: '#374151', fontSize: '15px', fontWeight: '600', cursor: 'pointer', width: '100%', transition: 'all 0.2s' },
  bizRegisterBtn: { padding: '15px', borderRadius: '12px', border: '2px solid #ede8fa', background: '#fff', color: '#374151', fontSize: '15px', fontWeight: '600', cursor: 'pointer', width: '100%', transition: 'all 0.2s', marginTop: '10px' },
  divider: { display: 'flex', alignItems: 'center', gap: '12px', margin: '24px 0' },
  dividerLine: { flex: 1, height: '1px', background: '#ede8fa' },
  dividerText: { color: '#a78bfa', fontSize: '13px' },
