  ...
  return (
      <div style={styles.container}>
        ...
        <div style={{ ...styles.loginWrapper, flexDirection: isMobile ? 'column' : 'row' }}>
          ...
          {/* Left panel — hidden on mobile, replaced by a slim header strip */}
          {isMobile ? (
              ...
              <div style={styles.leftPanel}>
                <div style={styles.leftContent}>
                  ...
                  <p style={styles.tagline}>Rewards and Loyalty points all in one place.</p>
                  <p style={styles.taglineSub}>– slogan subject to change</p>
                </div>
              </div>
          )}
          ...
          <div style={{
            ...
            <button style={styles.registerBtn} onClick={() => navigate('/register')}
                    onMouseEnter={e => { e.target.style.borderColor = ROYAL; e.target.style.color = ROYAL; }}
                    onMouseLeave={e => { e.target.style.borderColor = '#d0d0d0'; e.target.style.color = '#555'; }}>
              Create an Account
            </button>
...
const styles = {
  ...
  mobileHeader: {
    background: 'linear-gradient(145deg, #152a9e 0%, #1e35b5 100%)',
    padding: '24px',
