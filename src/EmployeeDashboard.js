...
const st = {
  ...
  stepTitle: { color: '#111', fontSize: '1.1rem', fontWeight: '700', margin: '0 0 2px 0' },
  stepSub: { color: '#888', fontSize: '13px', margin: 0 },
  lookupCard: { background: '#fff', borderRadius: '16px', padding: '20px', border: '1px solid #eee', boxShadow: '0 2px 12px rgba(0,0,0,0.05)' },
  ...
  changeCustomerBtn: { padding: '7px 12px', borderRadius: '8px', border: '1.5px solid #e0e0e0', background: 'transparent', color: '#666', fontSize: '12px', fontWeight: '600', cursor: 'pointer', flexShrink: 0 },
  ...
  emptyMenu: { background: '#fff', borderRadius: '14px', padding: '32px', textAlign: 'center', border: '1px solid #eee', color: '#555', fontSize: '14px' },
  ...
  menuItemName: { color: '#111', fontSize: '13px', fontWeight: '700', margin: '0 0 4px 0', paddingRight: '20px' },
  menuItemDesc: { color: '#888', fontSize: '11px', margin: '0 0 10px 0', lineHeight: 1.4 },
  ...
  confirmCard: { background: '#fff', borderRadius: '16px', padding: '20px', border: '1px solid #eee', boxShadow: '0 2px 12px rgba(0,0,0,0.05)' },
  ...
  confirmValue: { color: '#111', fontSize: '1rem', fontWeight: '700', margin: '0 0 14px 0' },
  confirmDivider: { height: '1px', background: '#f0f0f0', margin: '14px 0' },
  ...
  confirmTotalLabel: { color: '#111', fontSize: '14px', fontWeight: '700', margin: 0 },
  confirmTotalPts: { fontSize: '1.6rem', fontWeight: '800', margin: 0 },
  confirmActions: { display: 'flex', gap: '10px', marginTop: '20px' },
  backBtn: { padding: '12px 14px', borderRadius: '10px', border: '1.5px solid #e0e0e0', background: 'transparent', color: '#666', fontSize: '13px', fontWeight: '600', cursor: 'pointer', flex: 1 },
  issueBtn: { padding: '12px 14px', borderRadius: '10px', border: 'none', color: '#fff', fontSize: '14px', fontWeight: '700', cursor: 'pointer', flex: 2 },
  successCard: { background: '#fff', borderRadius: '20px', padding: '36px 24px', textAlign: 'center', boxShadow: '0 8px 40px rgba(0,0,0,0.08)', border: '1px solid #eee' },
  ...
  successTitle: { color: '#111', fontSize: '1.5rem', fontWeight: '800', margin: '0 0 8px 0' },
  successMsg: { color: '#555', fontSize: '14px', margin: '0 0 20px 0' },
