...
const s = {
  ...
  actionPrimary: { padding: '11px 22px', background: '#0B5CAD', color: '#FFFFFF', border: 'none', borderRadius: '10px', fontSize: '14px', fontWeight: '700', cursor: 'pointer', fontFamily: 'inherit', transition: 'background-color 0.15s ease' },
  actionSecondary: { padding: '11px 22px', background: 'transparent', color: 'var(--rn-ghost-color)', border: '1.5px solid var(--rn-ghost-border)', borderRadius: '10px', fontSize: '14px', fontWeight: '600', cursor: 'pointer', fontFamily: 'inherit' },
  section: {},
  ...
  skeleton: { height: '64px', borderRadius: '10px', background: 'var(--rn-card-bg)', backgroundSize: '200% 100%', animation: 'shimmer 1.4s infinite' },
  empty: { background: 'var(--rn-card-bg)', border: '1px solid var(--rn-card-border)', borderRadius: '12px', padding: '40px 24px', textAlign: 'center' },
